...
def extract_transaction_type(filename):
    ...
    transaction_type = filename.split('_')[1]
...
source_directory = '/Users/santhoshkumar/tazapay/Payout Recon/PPRO/txn'
destination_directory = '/Users/santhoshkumar/tazapay/Payout Recon/PPRO/txn/txn_type'
