...
folder_path = '/Users/santhoshkumar/tazapay/Payout Recon/PPRO/settlements/settle/2024/aggregate/raw/daily/20240118/unzipped'
...
for csv_file_path in csv_files:
    ...
    if not dfnew.empty:
        # Get the last row
        FX_FEE_RATE_PLN_USD = dfnew.iloc[-1]
        FX_CONVERSION_RATE_PLN_USD = dfnew.iloc[-2]
        SETTLEMENT_DATE = dfnew.iloc[-5]
        ...
        dfnew[SETTLEMENT_DATE["MERCHANT_ID"]] = SETTLEMENT_DATE["PAYMENT_METHOD"]
        dfnew[FX_CONVERSION_RATE_PLN_USD["MERCHANT_ID"]] = FX_CONVERSION_RATE_PLN_USD["PAYMENT_METHOD"]
        dfnew[FX_FEE_RATE_PLN_USD["MERCHANT_ID"]] = FX_FEE_RATE_PLN_USD["PAYMENT_METHOD"]
