...
folder_path = '/Users/santhoshkumar/tazapay/Payout Recon/PPRO/settlements/settle/volume_per_refund/unzipped/'
...
for csv_file_path in csv_files:
    ...
    if not dfnew.empty:
        ...
        dfnew[SETTLEMENT_DATE["MERCHANT_TX_ID"]] = SETTLEMENT_DATE["RF_ID"]
